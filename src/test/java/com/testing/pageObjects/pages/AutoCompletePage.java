...
public class AutoCompletePage extends WidgetsPage{
  ...
  public static By MULTIPLE_COLOR_FIELD = css("div[id='autoCompleteMultipleInput']");
  ...
  // Element to which you would send keystrokesdiv
  public static By SINGLE_COLOR_FIELD = css("div[id='autoCompleteSingleInput']");
  // Element containing the information about actual values
